...
<body>
    <div class="sidebar">
        <a href="#editContents" class="active">Edit Website Contents</a>
        <a href="#viewInquiries">View Customer Inquiries</a>
        <a href="#manageAdmin">Manage Admin Account</a>
    </div>
    <div class="main-content">
        <div class="container">
            <h1 class="text-center mb-4">Admin Panel</h1>

            <!-- Edit Website Contents Section -->
            <div id="editContents" class="admin-section">
                <div class="card card-body">
                    <h2 class="text-center mb-4">Edit Website Contents</h2>
                    <!-- Existing Admin Panel Content Here -->
            ...
            <!-- View Customer Inquiries Section -->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const mainSections = document.querySelectorAll('.admin-section');
            ...
            mainSections.forEach(section => {
                if (!section.id.includes('editContents')) {
                    section.style.display = 'none';
                }
            });
        });
